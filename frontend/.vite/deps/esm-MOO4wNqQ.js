...
function getBreakpointValue$1(breakpoint, breakpoints) {
	if (breakpoint in breakpoints) return px$1(breakpoints[breakpoint]);
	return px$1(breakpoint);
}
//#endregion
...
function MantineClasses() {
	...
	const classes = keys(theme.breakpoints).reduce((acc, breakpoint) => {
		...
		const pxValue = px$1(theme.breakpoints[breakpoint]);
...
var Collapse = factory((props) => {
	const { children, expanded, transitionDuration, transitionTimingFunction, style, onTransitionEnd, onTransitionStart, animateOpacity, keepMounted, ref, orientation, ...others } = useProps("Collapse", defaultProps$114, props);
...
function ScrollAreaRoot(_props) {
	const { type, scrollHideDelay, scrollbars, getStyles, ref, ...others } = useProps("ScrollAreaRoot", defaultProps$113, _props);
...
var varsResolver$92 = createVarsResolver((_, { scrollbarSize, overscrollBehavior, scrollbars }) => {
...
var ScrollArea = factory((_props) => {
	const props = useProps("ScrollArea", defaultProps$112, _props);
...
ScrollArea.varsResolver = varsResolver$92;
...
var defaultProps$111 = { __staticSelector: "UnstyledButton" };
var UnstyledButton = polymorphicFactory((_props) => {
	const props = useProps("UnstyledButton", defaultProps$111, _props);
...
var varsResolver$91 = createVarsResolver((_, { radius, shadow }) => ({ root: {
...
Paper.varsResolver = varsResolver$91;
...
var defaultProps$110 = { zIndex: getDefaultZIndex("modal") };
var varsResolver$90 = createVarsResolver((_, { gradient, color, backgroundOpacity, blur, radius, zIndex }) => ({ root: {
...
var Overlay = polymorphicFactory((_props) => {
	const props = useProps("Overlay", defaultProps$110, _props);
...
Overlay.varsResolver = varsResolver$90;
...
var defaultProps$109 = { reuseTargetNode: true };
var Portal = factory((props) => {
	const { children, target, reuseTargetNode, ref, ...others } = useProps("Portal", defaultProps$109, props);
	const [mounted, setMounted] = (0, import_react.useState)(false);
...
var PopoverTarget = factory((props) => {
	const { children, refProp, popupType, ref, ...others } = useProps("PopoverTarget", defaultProps$108, props);
	const child = getSingleElementChild(children);
...
var varsResolver$89 = createVarsResolver((_, { radius, shadow }) => ({ dropdown: {
	"--popover-radius": radius === void 0 ? void 0 : getRadius(radius),
	"--popover-shadow": getShadow(shadow)
} }));
function Popover(_props) {
	const props = useProps("Popover", defaultProps$107, _props);
...
Popover.varsResolver = varsResolver$89;
...
var varsResolver$88 = createVarsResolver((theme, { size, color }) => ({ root: {
	"--loader-size": getSize(size, "loader-size"),
	"--loader-color": color ? getThemeColor(color, theme) : void 0
} }));
var Loader = factory((_props) => {
	const props = useProps("Loader", defaultProps$106, _props);
...
Loader.varsResolver = varsResolver$88;
...
var defaultProps$105 = { orientation: "horizontal" };
var varsResolver$87 = createVarsResolver((_, { borderWidth }) => ({ group: { "--ai-border-width": rem(borderWidth) } }));
var ActionIconGroup = factory((_props) => {
	const props = useProps("ActionIconGroup", defaultProps$105, _props);
	const { className, style, classNames, styles, unstyled, orientation, vars, borderWidth, variant, mod, attributes, ...others } = useProps("ActionIconGroup", defaultProps$105, _props);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Box, {
		...useStyles({
...
ActionIconGroup.varsResolver = varsResolver$87;
ActionIconGroup.displayName = "@mantine/core/ActionIconGroup";
//#endregion
//#region node_modules/@mantine/core/esm/components/ActionIcon/ActionIconGroupSection/ActionIconGroupSection.mjs
var varsResolver$86 = createVarsResolver((theme, { radius, color, gradient, variant, autoContrast, size }) => {
...
ActionIconGroupSection.varsResolver = varsResolver$86;
...
var varsResolver$85 = createVarsResolver((theme, { size, radius, variant, gradient, color, autoContrast }) => {
	const colors = theme.variantColorResolver({
		color: color || theme.primaryColor,
		theme,
		gradient,
...
ActionIcon.varsResolver = varsResolver$85;
...
var defaultProps$104 = { variant: "subtle" };
var varsResolver$84 = createVarsResolver((_, { size, radius, iconSize }) => ({ root: {
...
var CloseButton = polymorphicFactory((_props) => {
	const props = useProps("CloseButton", defaultProps$104, _props);
...
CloseButton.varsResolver = varsResolver$84;
...
var varsResolver$83 = createVarsResolver((_, { grow, preventGrowOverflow, gap, align, justify, wrap }, { childWidth }) => ({ root: {
...
var Group = factory((_props) => {
	const props = useProps("Group", defaultProps$103, _props);
...
Group.varsResolver = varsResolver$83;
...
var varsResolver$82 = createVarsResolver((_, { size }) => ({ description: { "--input-description-size": size === void 0 ? void 0 : `calc(${getFontSize(size)} - ${rem(2)})` } }));
...
InputDescription.varsResolver = varsResolver$82;
InputDescription.displayName = "@mantine/core/InputDescription";
//#endregion
//#region node_modules/@mantine/core/esm/components/Input/InputError/InputError.mjs
var varsResolver$81 = createVarsResolver((_, { size }) => ({ error: { "--input-error-size": size === void 0 ? void 0 : `calc(${getFontSize(size)} - ${rem(2)})` } }));
...
InputError.varsResolver = varsResolver$81;
InputError.displayName = "@mantine/core/InputError";
//#endregion
//#region node_modules/@mantine/core/esm/components/Input/InputLabel/InputLabel.mjs
var defaultProps$102 = { labelElement: "label" };
var varsResolver$80 = createVarsResolver((_, { size }) => ({ label: {
	"--input-label-size": getFontSize(size),
	"--input-asterisk-color": void 0
} }));
var InputLabel = factory((_props) => {
	const props = useProps("InputLabel", defaultProps$102, _props);
...
InputLabel.varsResolver = varsResolver$80;
...
var varsResolver$79 = createVarsResolver((_, { size }) => ({
	label: {
		"--input-label-size": getFontSize(size),
		"--input-asterisk-color": void 0
	},
...
var InputWrapper = factory((_props) => {
	const props = useProps("InputWrapper", defaultProps$101, _props);
...
InputWrapper.varsResolver = varsResolver$79;
...
var varsResolver$78 = createVarsResolver((_, props, ctx) => ({ wrapper: {
...
var Input = polymorphicFactory((_props) => {
	const props = useProps("Input", defaultProps$100, _props);
...
Input.varsResolver = varsResolver$78;
...
var InputBase = polymorphicFactory((props) => {
	const { inputProps, wrapperProps, ...others } = useInputProps("InputBase", defaultProps$99, props);
...
var varsResolver$77 = createVarsResolver((theme, { transitionDuration }, { shouldReduceMotion }) => {
...
FloatingIndicator.varsResolver = varsResolver$77;
//#endregion
...
var varsResolver$76 = createVarsResolver((_, { transitionDuration, chevronSize, radius }) => ({ root: {
...
var Accordion = genericFactory((_props) => {
	const props = useProps("Accordion", defaultProps$98, _props);
...
Accordion.varsResolver = varsResolver$76;
...
var varsResolver$75 = createVarsResolver((_, { zIndex, position }) => ({ root: {
...
var Affix = factory((_props) => {
	const props = useProps("Affix", defaultProps$97, _props);
...
Affix.varsResolver = varsResolver$75;
...
var varsResolver$74 = createVarsResolver((theme, { radius, color, variant, autoContrast }) => {
	const colors = theme.variantColorResolver({
		color: color || theme.primaryColor,
		theme,
...
Alert.varsResolver = varsResolver$74;
...
var defaultProps$96 = { inherit: false };
var varsResolver$73 = createVarsResolver((theme, { variant, lineClamp, gradient, size }) => ({ root: {
...
var Text = polymorphicFactory((_props) => {
	const props = useProps("Text", defaultProps$96, _props);
...
Text.varsResolver = varsResolver$73;
...
var defaultProps$95 = { underline: "hover" };
var Anchor = polymorphicFactory((props) => {
	const { underline, className, unstyled, mod, ...others } = useProps("Anchor", defaultProps$95, props);
...
var varsResolver$72 = createVarsResolver((_, { size, thumbSize }) => ({ root: {
	"--slider-size": rem(size),
	"--thumb-size": rem(thumbSize)
} }));
var AngleSlider = factory((_props) => {
	const props = useProps("AngleSlider", defaultProps$94, _props);
...
AngleSlider.varsResolver = varsResolver$72;
//#endregion
...
var varsResolver$71 = createVarsResolver((_, { transitionDuration, transitionTimingFunction }) => ({ root: {
...
var AppShell = factory((_props) => {
	const props = useProps("AppShell", defaultProps$93, _props);
...
AppShell.varsResolver = varsResolver$71;
...
var varsResolver$70 = createVarsResolver((_, { ratio }) => ({ root: { "--ar-ratio": ratio?.toString() } }));
...
AspectRatio.varsResolver = varsResolver$70;
...
var defaultProps$92 = { error: null };
var varsResolver$69 = createVarsResolver((theme, { size, color }) => ({ chevron: {
...
var ComboboxChevron = factory((_props) => {
	const props = useProps("ComboboxChevron", defaultProps$92, _props);
...
ComboboxChevron.varsResolver = varsResolver$69;
...
var defaultProps$91 = { refProp: "ref" };
var ComboboxDropdownTarget = factory((props) => {
	const { children, refProp, ref } = useProps("ComboboxDropdownTarget", defaultProps$91, props);
	useComboboxContext();
...
var ComboboxEventsTarget = factory((props) => {
	const { children, refProp, withKeyboardNavigation, withAriaAttributes, withExpandedAttribute, targetType, autoComplete, ref, ...others } = useProps("ComboboxEventsTarget", defaultProps$90, props);
	const child = getSingleElementChild(children);
...
var ComboboxSearch = factory((_props) => {
	const { classNames, styles, unstyled, vars, withAriaAttributes, onKeyDown, onClick, withKeyboardNavigation, size, ref, ...others } = useProps("ComboboxSearch", defaultProps$89, _props);
	const ctx = useComboboxContext();
...
var ComboboxTarget = factory((props) => {
	const { children, refProp, withKeyboardNavigation, withAriaAttributes, withExpandedAttribute, targetType, autoComplete, ref, ...others } = useProps("ComboboxTarget", defaultProps$88, props);
	const child = getSingleElementChild(children);
...
var varsResolver$68 = createVarsResolver((_, { size, dropdownPadding }) => ({
	options: {
...
var Combobox = (_props) => {
	const props = useProps("Combobox", defaultProps$87, _props);
...
Combobox.varsResolver = varsResolver$68;
...
var defaultProps$86 = { hiddenInputValuesSeparator: "," };
var CheckboxGroup = genericFactory(((props) => {
	const { value, defaultValue, onChange, size, wrapperProps, children, readOnly, name, hiddenInputValuesSeparator, hiddenInputProps, maxSelectedValues, disabled, ...others } = useProps("CheckboxGroup", defaultProps$86, props);
	const [_value, setValue] = useUncontrolled({
		value,
		defaultValue,
		finalValue: [],
...
var defaultProps$85 = { withBorder: true };
var varsResolver$67 = createVarsResolver((_, { radius }) => ({ card: { "--card-radius": getRadius(radius) } }));
var CheckboxCard = factory((_props) => {
	const props = useProps("CheckboxCard", defaultProps$85, _props);
...
CheckboxCard.varsResolver = varsResolver$67;
//#endregion
...
var CheckboxIndicator = factory((_props) => {
	const props = useProps("CheckboxIndicator", defaultProps$84, _props);
...
CheckboxIndicator.varsResolver = varsResolver$66;
//#endregion
...
var varsResolver$65 = createVarsResolver((theme, { radius, color, size, iconColor, variant, autoContrast }) => {
	const parsedColor = parseThemeColor({
		color: color || theme.primaryColor,
		theme
	});
...
var Checkbox = factory((_props) => {
	const props = useProps("Checkbox", defaultProps$83, _props);
...
Checkbox.varsResolver = varsResolver$65;
...
var varsResolver$64 = createVarsResolver((_, { spacing }) => ({ group: { "--ag-spacing": getSpacing(spacing) } }));
...
AvatarGroup.varsResolver = varsResolver$64;
...
var varsResolver$63 = createVarsResolver((theme, { size, radius, variant, gradient, color, autoContrast, name, allowedInitialsColors }) => {
...
Avatar.varsResolver = varsResolver$63;
...
var varsResolver$62 = createVarsResolver((_, { radius }) => ({ root: { "--bi-radius": radius === void 0 ? void 0 : getRadius(radius) } }));
...
BackgroundImage.varsResolver = varsResolver$62;
...
var varsResolver$61 = createVarsResolver((theme, { radius, color, gradient, variant, size, autoContrast, circle }) => {
	const colors = theme.variantColorResolver({
		color: color || theme.primaryColor,
		theme,
		gradient,
...
Badge.varsResolver = varsResolver$61;
...
var defaultProps$82 = { iconSize: 48 };
var varsResolver$60 = createVarsResolver((theme, { color, iconSize, radius }) => {
...
var Blockquote = factory((_props) => {
	const props = useProps("Blockquote", defaultProps$82, _props);
...
Blockquote.varsResolver = varsResolver$60;
...
var defaultProps$81 = { separator: "/" };
var varsResolver$59 = createVarsResolver((_, { separatorMargin }) => ({ root: { "--bc-separator-margin": getSpacing(separatorMargin) } }));
var Breadcrumbs = factory((_props) => {
	const props = useProps("Breadcrumbs", defaultProps$81, _props);
...
Breadcrumbs.varsResolver = varsResolver$59;
...
var varsResolver$58 = createVarsResolver((theme, { color, size, lineSize, transitionDuration, transitionTimingFunction }) => ({ root: {
...
Burger.varsResolver = varsResolver$58;
...
var defaultProps$80 = { orientation: "horizontal" };
var varsResolver$57 = createVarsResolver((_, { borderWidth }) => ({ group: { "--button-border-width": rem(borderWidth) } }));
var ButtonGroup = factory((_props) => {
	const props = useProps("ButtonGroup", defaultProps$80, _props);
	const { className, style, classNames, styles, unstyled, orientation, vars, borderWidth, mod, attributes, ...others } = useProps("ButtonGroup", defaultProps$80, _props);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Box, {
		...useStyles({
			name: "ButtonGroup",
			props,
...
ButtonGroup.varsResolver = varsResolver$57;
ButtonGroup.displayName = "@mantine/core/ButtonGroup";
//#endregion
//#region node_modules/@mantine/core/esm/components/Button/ButtonGroupSection/ButtonGroupSection.mjs
var varsResolver$56 = createVarsResolver((theme, { radius, color, gradient, variant, autoContrast, size }) => {
	const colors = theme.variantColorResolver({
		color: color || theme.primaryColor,
		theme,
		gradient,
...
ButtonGroupSection.varsResolver = varsResolver$56;
...
var varsResolver$55 = createVarsResolver((theme, { radius, color, gradient, variant, size, justify, autoContrast }) => {
	const colors = theme.variantColorResolver({
		color: color || theme.primaryColor,
		theme,
		gradient,
...
Button.varsResolver = varsResolver$55;
...
var varsResolver$54 = createVarsResolver((_, { padding }) => ({ root: { "--card-padding": getSpacing(padding) } }));
var defaultProps$79 = { orientation: "vertical" };
var Card = polymorphicFactory((_props) => {
	const props = useProps("Card", defaultProps$79, _props);
...
Card.varsResolver = varsResolver$54;
...
var defaultProps$78 = { type: "checkbox" };
var varsResolver$53 = createVarsResolver((theme, { size, radius, variant, color, autoContrast }) => {
	const colors = theme.variantColorResolver({
		color: color || theme.primaryColor,
		theme,
		variant: variant || "filled",
...
var Chip = factory((_props) => {
	const props = useProps("Chip", defaultProps$78, _props);
...
Chip.varsResolver = varsResolver$53;
...
var varsResolver$52 = createVarsResolver((theme, { color }) => ({ root: { "--code-bg": color ? getThemeColor(color, theme) : void 0 } }));
...
Code.varsResolver = varsResolver$52;
...
var defaultProps$77 = { withShadow: true };
var varsResolver$51 = createVarsResolver((_, { radius, size }) => ({ root: {
	"--cs-radius": radius === void 0 ? void 0 : getRadius(radius),
	"--cs-size": rem(size)
} }));
var ColorSwatch = polymorphicFactory((_props) => {
	const props = useProps("ColorSwatch", defaultProps$77, _props);
	const { classNames, className, style, styles, unstyled, vars, color, radius, withShadow, children, attributes, ...others } = useProps("ColorSwatch", defaultProps$77, props);
	const getStyles = useStyles({
		name: "ColorSwatch",
		props,
...
ColorSwatch.varsResolver = varsResolver$51;
...
var defaultProps$76 = { __staticSelector: "AlphaSlider" };
var AlphaSlider = factory((props) => {
	const { value, onChange, onChangeEnd, color, ...others } = useProps("AlphaSlider", defaultProps$76, props);
...
var defaultProps$75 = { __staticSelector: "HueSlider" };
var HueSlider = factory((props) => {
	const { value, onChange, onChangeEnd, color, ...others } = useProps("HueSlider", defaultProps$75, props);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ColorSlider, {
		...others,
		value,
		onChange,
...
var varsResolver$50 = createVarsResolver((_, { size, swatchesPerRow }) => ({ wrapper: {
...
var ColorPicker = factory((_props) => {
	const props = useProps("ColorPicker", defaultProps$74, _props);
...
ColorPicker.varsResolver = varsResolver$50;
...
var varsResolver$49 = createVarsResolver((_, { size }) => ({
...
ColorInput.varsResolver = varsResolver$49;
...
var defaultProps$72 = { strategy: "block" };
var varsResolver$48 = createVarsResolver((_, { size, fluid }) => ({ root: { "--container-size": fluid ? void 0 : getSize(size, "container-size") } }));
var Container = factory((_props) => {
	const props = useProps("Container", defaultProps$72, _props);
...
Container.varsResolver = varsResolver$48;
Container.displayName = "@mantine/core/Container";
//#endregion
//#region node_modules/@mantine/core/esm/components/CopyButton/CopyButton.mjs
var defaultProps$71 = { timeout: 1e3 };
function CopyButton(props) {
	const { children, timeout, value, ...others } = useProps("CopyButton", defaultProps$71, props);
...
var varsResolver$47 = createVarsResolver((_, { size }) => ({ root: { "--dialog-size": getSize(size, "dialog-size") } }));
var Dialog = factory((_props) => {
	const props = useProps("Dialog", defaultProps$70, _props);
...
Dialog.varsResolver = varsResolver$47;
...
var defaultProps$69 = { orientation: "horizontal" };
var varsResolver$46 = createVarsResolver((theme, { color, variant, size }) => ({ root: {
...
var Divider = factory((_props) => {
	const props = useProps("Divider", defaultProps$69, _props);
...
Divider.varsResolver = varsResolver$46;
...
var varsResolver$45 = createVarsResolver((_, { position, size, offset }) => ({ root: {
...
var DrawerRoot = factory((_props) => {
	const props = useProps("DrawerRoot", defaultProps$68, _props);
...
DrawerRoot.varsResolver = varsResolver$45;
...
var Drawer = factory((_props) => {
	const { title, withOverlay, overlayProps, withCloseButton, closeButtonProps, children, opened, stackId, zIndex, ...others } = useProps("Drawer", defaultProps$67, _props);
...
var defaultProps$66 = { variant: "default" };
var varsResolver$44 = createVarsResolver((_, { radius }) => ({ root: { "--fieldset-radius": radius === void 0 ? void 0 : getRadius(radius) } }));
var Fieldset = factory((_props) => {
	const props = useProps("Fieldset", defaultProps$66, _props);
...
Fieldset.varsResolver = varsResolver$44;
...
var FileInput = genericFactory((_props) => {
	const props = useProps("FileInput", defaultProps$65, _props);
...
var FloatingWindow = factory((_props) => {
	const props = useProps("FloatingWindow", defaultProps$64, _props);
...
var defaultProps$63 = { span: 12 };
var GridCol = factory((_props) => {
	const { classNames, className, style, styles, vars, span, order, offset, align, ...others } = useProps("GridCol", defaultProps$63, _props);
	const ctx = useGridContext();
...
var varsResolver$43 = createVarsResolver((_, { justify, align, overflow }) => ({ root: {
	"--grid-justify": justify,
	"--grid-align": align,
	"--grid-overflow": overflow
} }));
var Grid = factory((_props) => {
	const props = useProps("Grid", defaultProps$62, _props);
...
Grid.varsResolver = varsResolver$43;
...
var defaultProps$61 = { color: "yellow" };
var varsResolver$42 = createVarsResolver((theme, { color }) => ({ root: {
...
var Mark = factory((_props) => {
	const props = useProps("Mark", defaultProps$61, _props);
...
Mark.varsResolver = varsResolver$42;
...
var Highlight = polymorphicFactory((_props) => {
	const { unstyled, children, highlight, highlightStyles, color, wholeWord, ...others } = useProps("Highlight", defaultProps$60, _props);
...
function HoverCardGroup(props) {
	const { openDelay, closeDelay, children } = useProps("HoverCardGroup", defaultProps$59, props);
...
var defaultProps$58 = { refProp: "ref" };
function HoverCardTarget(props) {
	const { children, refProp, eventPropsWrapperName, ...others } = useProps("HoverCardTarget", defaultProps$58, props);
	const child = getSingleElementChild(children);
...
function HoverCard(props) {
	const { children, onOpen, onClose, openDelay, closeDelay, initiallyOpened, ...others } = useProps("HoverCard", defaultProps$57, props);
...
var varsResolver$41 = createVarsResolver((_, { radius, fit }) => ({ root: {
...
Image.varsResolver = varsResolver$41;
...
var varsResolver$40 = createVarsResolver((theme, { color, position, offset, size, radius, zIndex, autoContrast }) => ({ root: {
...
var Indicator = factory((_props) => {
	const props = useProps("Indicator", defaultProps$56, _props);
...
Indicator.varsResolver = varsResolver$40;
...
var defaultProps$55 = { size: "sm" };
var Textarea = factory((props) => {
	const { autosize, maxRows, minRows, __staticSelector, resize, ...others } = useProps("Textarea", defaultProps$55, props);
...
var JsonInput = factory((props) => {
	const { value, defaultValue, onChange, formatOnBlur, validationError, serialize, deserialize, onFocus, onBlur, readOnly, error, indentSpaces, ...others } = useProps("JsonInput", defaultProps$54, props);
	const [_value, setValue] = useUncontrolled({
		value,
		defaultValue,
		finalValue: "",
...
var varsResolver$39 = createVarsResolver((_, { size }) => ({ root: { "--kbd-fz": getSize(size, "kbd-fz") } }));
...
Kbd.varsResolver = varsResolver$39;
...
var defaultProps$53 = { type: "unordered" };
var varsResolver$38 = createVarsResolver((_, { size, spacing }) => ({ root: {
	"--list-fz": getFontSize(size),
	"--list-lh": getLineHeight(size),
	"--list-spacing": getSpacing(spacing)
} }));
var List = factory((_props) => {
	const props = useProps("List", defaultProps$53, _props);
...
List.varsResolver = varsResolver$38;
...
var varsResolver$37 = createVarsResolver((_, { zIndex }) => ({ root: { "--lo-z-index": zIndex?.toString() } }));
var LoadingOverlay = factory((_props) => {
	const props = useProps("LoadingOverlay", defaultProps$52, _props);
...
LoadingOverlay.varsResolver = varsResolver$37;
...
var varsResolver$36 = createVarsResolver((_, { duration, gap, repeat, fadeEdgeColor, fadeEdgeSize }) => ({ root: {
...
var Marquee = factory((_props) => {
	const props = useProps("Marquee", defaultProps$51, _props);
...
Marquee.varsResolver = varsResolver$36;
...
var MaskInput = factory((props) => {
	const { maskRef, elementProps } = useMaskInputProps(useProps("MaskInput", defaultProps$50, props));
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(InputBase, {
		component: "input",
		ref: maskRef,
		...elementProps,
...
function MenuSub(_props) {
	const { children, closeDelay, openDelay, ...others } = useProps("MenuSub", defaultProps$49, _props);
	const id = useId$1$1();
...
var defaultProps$48 = { refProp: "ref" };
function MenuTarget(props) {
	const { children, refProp, ...others } = useProps("MenuTarget", defaultProps$48, props);
	const child = getSingleElementChild(children);
...
var Menu = factory((_props) => {
	const props = useProps("Menu", defaultProps$47, _props);
...
var varsResolver$35 = createVarsResolver((_, { radius, size, yOffset, xOffset }) => ({ root: {
...
var ModalRoot = factory((_props) => {
	const props = useProps("ModalRoot", defaultProps$46, _props);
...
ModalRoot.varsResolver = varsResolver$35;
...
var Modal = factory((_props) => {
	const { title, withOverlay, overlayProps, withCloseButton, closeButtonProps, children, radius, opened, stackId, zIndex, ...others } = useProps("Modal", defaultProps$45, _props);
...
var varsResolver$34 = createVarsResolver((_, { gap }, { size }) => ({ group: { "--pg-gap": gap !== void 0 ? getSize(gap) : getSize(size, "pg-gap") } }));
...
PillGroup.varsResolver = varsResolver$34;
PillGroup.displayName = "@mantine/core/PillGroup";
//#endregion
//#region node_modules/@mantine/core/esm/components/Pill/Pill.mjs
var defaultProps$44 = { variant: "default" };
var varsResolver$33 = createVarsResolver((_, { radius }, { size }) => ({ root: {
...
var Pill = factory((_props) => {
	const props = useProps("Pill", defaultProps$44, _props);
...
Pill.varsResolver = varsResolver$33;
...
var defaultProps$43 = { type: "visible" };
var PillsInputField = factory((_props) => {
	const props = useProps("PillsInputField", defaultProps$43, _props);
...
var defaultProps$42 = { size: "sm" };
var PillsInput = factory((_props) => {
	const { children, onMouseDown, onClick, size, disabled, __staticSelector, error, variant, ...others } = useProps("PillsInput", defaultProps$42, _props);
...
var MultiSelect = genericFactory((_props) => {
	const props = useProps("MultiSelect", defaultProps$41, _props);
...
var NativeSelect = factory((props) => {
	const { data, children, size, error, rightSection, unstyled, ...others } = useProps("NativeSelect", defaultProps$40, props);
...
var varsResolver$32 = createVarsResolver((theme, { variant, color, childrenOffset, autoContrast }) => {
	const colors = theme.variantColorResolver({
		color: color || theme.primaryColor,
		theme,
		variant: variant || "light",
...
NavLink.varsResolver = varsResolver$32;
...
var defaultProps$39 = { withCloseButton: true };
var varsResolver$31 = createVarsResolver((theme, { radius, color }) => ({ root: {
...
var Notification = factory((_props) => {
	const props = useProps("Notification", defaultProps$39, _props);
...
Notification.varsResolver = varsResolver$31;
...
var varsResolver$30 = createVarsResolver((_, { size }) => ({ controls: { "--ni-chevron-size": getSize(size, "ni-chevron-size") } }));
...
var NumberInput = genericFactory((_props) => {
	const props = useProps("NumberInput", defaultProps$38, _props);
	...
	const stepNumber = typeof step === "number" ? step : defaultProps$38.step;
	const startValueNumber = typeof startValue === "number" ? startValue : defaultProps$38.startValue;
...
NumberInput.varsResolver = varsResolver$30;
...
var varsResolver$29 = createVarsResolver((_, { gap }) => ({ root: { "--ol-gap": getSpacing(gap) } }));
var OverflowList = genericFactory((_props) => {
	const props = useProps("OverflowList", defaultProps$37, _props);
...
OverflowList.varsResolver = varsResolver$29;
//#endregion
...
var defaultProps$36 = { withPadding: true };
var PaginationControl = factory((_props) => {
	const { classNames, className, style, styles, vars, active, disabled, withPadding, mod, ...others } = useProps("PaginationControl", defaultProps$36, _props);
...
var defaultProps$35 = { icon: PaginationDotsIcon };
var PaginationDots = factory((_props) => {
	const { classNames, className, style, styles, vars, icon: Icon, ...others } = useProps("PaginationDots", defaultProps$35, _props);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Box, {
...
var varsResolver$28 = createVarsResolver((theme, { size, radius, color, autoContrast }) => ({ root: {
...
var PaginationRoot = factory((_props) => {
	const props = useProps("PaginationRoot", defaultProps$34, _props);
...
PaginationRoot.varsResolver = varsResolver$28;
...
var Pagination = factory((_props) => {
	const { withEdges, withControls, getControlProps, nextIcon, previousIcon, lastIcon, firstIcon, dotsIcon, total, gap, hideWithOnePage, withPages, ...others } = useProps("Pagination", defaultProps$33, _props);
...
PasswordInput.varsResolver = varsResolver$27;
...
var varsResolver$26 = createVarsResolver((_, { size }) => ({ root: { "--pin-input-size": getSize(size ?? "sm", "pin-input-size") } }));
var PinInput = factory((props) => {
	const { name, form, className, value, defaultValue, variant, gap, style, size, classNames, styles, unstyled, length, onChange, onComplete, manageFocus, autoFocus, error, radius, disabled, oneTimeCode, placeholder, type, mask, readOnly, inputType, inputMode, ariaLabel, vars, id, hiddenInputProps, rootRef, getInputProps, attributes, ref, ...others } = useProps("PinInput", defaultProps$31, props);
	const uuid = useId$1$1(id);
	const getStyles = useStyles({
		name: "PinInput",
...
PinInput.varsResolver = varsResolver$26;
...
var varsResolver$25 = createVarsResolver((_, { size, radius, transitionDuration }) => ({ root: {
...
ProgressRoot.varsResolver = varsResolver$25;
...
var defaultProps$30 = { withAria: true };
var ProgressSection = factory((props) => {
	const { classNames, className, style, styles, vars, value, withAria, color, striped, animated, mod, ...others } = useProps("ProgressSection", defaultProps$30, props);
...
var defaultProps$29 = { withBorder: true };
var varsResolver$24 = createVarsResolver((_, { radius }) => ({ card: { "--card-radius": getRadius(radius) } }));
var RadioCard = factory((_props) => {
	const props = useProps("RadioCard", defaultProps$29, _props);
...
RadioCard.varsResolver = varsResolver$24;
//#endregion
...
var defaultProps$28 = { icon: RadioIcon };
var varsResolver$23 = createVarsResolver((theme, { radius, color, size, iconColor, variant, autoContrast }) => {
	const parsedColor = parseThemeColor({
		color: color || theme.primaryColor,
		theme
	});
...
var RadioIndicator = factory((_props) => {
	const props = useProps("RadioIndicator", defaultProps$28, _props);
...
RadioIndicator.varsResolver = varsResolver$23;
//#endregion
...
var varsResolver$22 = createVarsResolver((theme, { size, radius, color, iconColor, variant, autoContrast }) => {
	const parsedColor = parseThemeColor({
		color: color || theme.primaryColor,
		theme
	});
...
var Radio = factory((_props) => {
	const props = useProps("Radio", defaultProps$27, _props);
...
Radio.varsResolver = varsResolver$22;
...
var varsResolver$21 = createVarsResolver((theme, { size, color }) => ({ root: {
	"--rating-size": getSize(size, "rating-size"),
	"--rating-color": getThemeColor(color, theme)
} }));
var Rating = factory((_props) => {
	const props = useProps("Rating", defaultProps$26, _props);
...
Rating.varsResolver = varsResolver$21;
...
var TooltipFloating = factory((_props) => {
	const props = useProps("TooltipFloating", defaultProps$25, _props);
...
function TooltipGroup(props) {
	const { openDelay, closeDelay, children } = useProps("TooltipGroup", defaultProps$24, props);
...
var Tooltip = factory((_props) => {
	const props = useProps("Tooltip", defaultProps$23, _props);
...
var RingProgress = factory((_props) => {
	const props = useProps("RingProgress", defaultProps$22, _props);
...
var Scroller = factory((_props) => {
	const props = useProps("Scroller", defaultProps$21, _props);
...
var defaultProps$20 = { withItemsBorders: true };
...
var SegmentedControl = genericFactory((_props) => {
	const props = useProps("SegmentedControl", defaultProps$20, _props);
...
var Select = genericFactory((_props) => {
	const props = useProps("Select", defaultProps$19, _props);
...
var SemiCircleProgress = factory((_props) => {
	const props = useProps("SemiCircleProgress", defaultProps$18, _props);
...
function sortBreakpoints(breakpoints) {
	return breakpoints.sort((a, b) => px$1(a) - px$1(b));
}
...
var SimpleGrid = factory((_props) => {
	const props = useProps("SimpleGrid", defaultProps$17, _props);
...
var Skeleton = factory((_props) => {
	const props = useProps("Skeleton", defaultProps$16, _props);
...
var Slider = factory((_props) => {
	const props = useProps("Slider", defaultProps$15, _props);
...
var RangeSlider = factory((_props) => {
	const props = useProps("RangeSlider", defaultProps$14, _props);
...
var Spoiler = factory((_props) => {
	const props = useProps("Spoiler", defaultProps$13, _props);
...
var Stack = factory((_props) => {
	const props = useProps("Stack", defaultProps$12, _props);
...
var StepperStep = factory((props) => {
	const { classNames, className, style, styles, vars, step, state, color, icon, completedIcon, progressIcon, label, description, withIcon, iconSize, loading, allowStepClick, allowStepSelect, iconPosition, orientation, mod, ...others } = useProps("StepperStep", defaultProps$11, props);
...
var Stepper = factory((_props) => {
	const props = useProps("Stepper", defaultProps$10, _props);
...
var defaultProps$9 = { hiddenInputValuesSeparator: "," };
var SwitchGroup = genericFactory(((props) => {
	const { value, defaultValue, onChange, size, wrapperProps, children, readOnly, name, hiddenInputValuesSeparator, hiddenInputProps, maxSelectedValues, disabled, ...others } = useProps("SwitchGroup", defaultProps$9, props);
	const [_value, setValue] = useUncontrolled({
		value,
		defaultValue,
		finalValue: [],
...
//#endregion
export { TooltipGroup as $, MantineThemeContext as $a, PopoverTarget as $i, convertHsvaTo as $n, useDidUpdate as $o, getParsedComboboxData as $r, MenuTarget as $t, TableThead as A, useRandomClassName as Aa, InputError as Ai, useGridContext as An, darken as Ao, CheckboxCard as Ar, Notification as At, Stack as B, mantineHtmlProps as Ba, ModalBaseCloseButton as Bi, DrawerOverlay as Bn, resolveClassNames as Bo, ComboboxHiddenInput as Br, useModalsStack as Bt, Table as C, Box as Ca, FLEX_STYLE_PROPS_DATA as Ci, HoverCardGroup as Cn, getContrastColor as Co, useVirtualizedCombobox as Cr, em as Cs, PaginationPrevious as Ct, TableTd as D, createPolymorphicComponent as Da, InputWrapper as Di, Mark as Dn, alpha as Do, Checkbox as Dr, deepMerge as Ds, OverflowList as Dt, TableTbody as E, genericFactory as Ea, Input as Ei, Highlight as En, defaultVariantColorsResolver as Eo, isOptionsGroup as Er, camelToKebabCase as Es, usePaginationContext as Et, SwitchGroupContext as F, InlineStyles as Fa, NativeScrollArea as Fi, Drawer as Fn, toRgba as Fo, useCombobox as Fr, PillsInputField as Ft, Skeleton as G, HeadlessMantineProvider as Ga, CloseButton as Gi, useDrawerContext as Gn, getRootElement as Go, useComboboxTargetProps as Gr, ModalRoot as Gt, Space as H, mergeThemeOverrides as Ha, ModalBase as Hi, DrawerContent as Hn, getSingleElementChild as Ho, ComboboxGroup as Hr, ModalTitle as Ht, Stepper as I, stylesToString as Ia, ModalBaseTitle as Ii, DrawerTitle as In, getPrimaryShade as Io, ComboboxTarget as Ir, Pill as It, Select as J, defaultCssVariablesResolver as Ja, ActionIconGroupSection as Ji, CopyButton as Jn, findClosestNumber as Jo, ComboboxDropdown as Jr, ModalContent as Jt, SimpleGrid as K, MantineProvider as Ka, CloseIcon as Ki, Divider as Kn, isPrimitive as Ko, ComboboxEmpty as Kr, ModalOverlay as Kt, StepperStep as L, useStyles as La, ModalBaseOverlay as Li, DrawerStack as Ln, localStorageColorSchemeManager as Lo, ComboboxSearch as Lr, PillGroup as Lt, useTableContext as M, STYlE_PROPS_DATA as Ma, InputWrapperContext as Mi, FileInput as Mn, parseThemeColor as Mo, CheckboxGroup as Mr, NativeSelect as Mt, Switch as N, extractStyleProps as Na, InputClearSection as Ni, FileButton as Nn, isLightColor as No, CheckboxGroupContext as Nr, MultiSelect as Nt, TableTfoot as O, polymorphic as Oa, InputPlaceholder as Oi, Grid as On, rgba as Oo, CheckboxIndicator as Or, keys as Os, NumberInput as Ot, SwitchGroup as P, hashStyleProps as Pa, InputClearButton as Pi, Fieldset as Pn, luminance as Po, Combobox as Pr, PillsInput as Pt, Tooltip as Q, convertCssVariables as Qa, Popover as Qi, HueSlider as Qn, useReducedMotion as Qo, getOptionsLockup as Qr, Menu as Qt, StepperCompleted as R, FOCUS_CLASS_NAMES as Ra, ModalBaseHeader as Ri, DrawerStackContext as Rn, isMantineColorScheme as Ro, ComboboxOptions as Rr, PillsInputContext as Rt, TableOfContents as S, useDirection as Sa, Flex as Si, HoverCardDropdown as Sn, getAutoContrastValue as So, Autocomplete as Sr, filterProps as Ss, PaginationNext as St, TableCaption as T, factory as Ta, useInputProps as Ti, useHoverCardContext as Tn, lighten as To, defaultOptionsFilter as Tr, px$1 as Ts, PaginationControl as Tt, RangeSlider as U, createTheme as Ua, ReactRemoveScroll as Ui, DrawerCloseButton as Un, findElementBySelector as Uo, ComboboxFooter as Ur, ModalStack as Ut, Spoiler as V, useMatches as Va, ModalBaseBody as Vi, DrawerHeader as Vn, createVarsResolver as Vo, ComboboxHeader as Vr, Modal as Vt, Slider as W, useProps as Wa, Group as Wi, DrawerBody as Wn, findElementsBySelector as Wo, ComboboxEventsTarget as Wr, ModalStackContext as Wt, Scroller as X, virtualColor as Xa, Loader as Xi, ColorInput as Xn, getEnv as Xo, useComboboxContext as Xr, ModalBody as Xt, SegmentedControl as Y, isVirtualColor as Ya, ActionIconGroup as Yi, Container as Yn, memoize as Yo, ComboboxClearButton as Yr, ModalCloseButton as Yt, RingProgress as Z, getCSSColorVariables as Za, defaultLoaders as Zi, ColorPicker as Zn, createUseExternalEvents as Zo, ComboboxChevron as Zr, useModalContext as Zt, Tabs as _, ScrollAreaAutosize as _a, AccordionControl as _i, Textarea as _n, useMantineStyleNonce as _o, Badge as _r, findElementAncestor as _s, Pagination as _t, filterTreeData as a, Transition as aa, AppShellHeader as ai, MenuItem as an, DEFAULT_THEME as ao, Chip as ar, getBreakpointValue$1 as as, RadioIcon as at, TabsList as b, DirectionContext as ba, useAccordionContext as bi, HoverCard as bn, useMantineWithStaticClasses as bo, AvatarGroup as br, isElement$1 as bs, PaginationFirst as bt, Tree as c, Portal as ca, useAppShellContext as ci, useMenuContext as cn, useProviderColorScheme as co, Center as cr, getLineHeight as cs, RadioGroup as ct, Title as d, getFloatingPosition as da, Text as di, LoadingOverlay as dn, useMantineClassNamesPrefix as do, Button as dr, getSize as ds, ProgressSection as dt, PopoverDropdown as ea, AspectRatio as ei, MenuSub as en, MantineThemeProvider as eo, AlphaSlider as er, randomId as es, TooltipGroupContext as et, Timeline as f, FloatingArrow as fa, Alert as fi, List as fn, useMantineContext as fo, ButtonGroupSection as fr, getSpacing as fs, ProgressRoot as ft, TagsInput as g, ScrollArea as ga, AccordionItem as gi, JsonInput as gn, useMantineIsHeadless as go, Blockquote as gr, createScopedKeydownHandler as gs, PasswordInput as gt, TextInput as h, UnstyledButton as ha, AccordionPanel as hi, Kbd as hn, useMantineEnv as ho, Breadcrumbs as hr, getDefaultZIndex as hs, PinInput as ht, defaultTreeNodeFilter as i, getTransitionProps as ia, AppShellMain as ii, MenuLabel as in, validateMantineTheme as io, Code as ir, getSortedBreakpoints as is, RadioIndicator as it, TableTr as j, parseStyleProps as ja, InputDescription as ji, FloatingWindow as jn, getThemeColor as jo, CheckboxCardContext as jr, NavLink as jt, TableTh as k, getStyleObject as ka, InputLabel as ki, GridCol as kn, getGradient as ko, CheckIcon as kr, NumberFormatter as kt, getTreeExpandedState as l, Overlay as la, AngleSlider as li, MaskInput as ln, useMantineColorScheme as lo, Card as lr, getRadius as ls, RadioGroupContext as lt, ThemeIcon as m, VisuallyHidden as ma, Accordion as mi, useListContext as mn, useMantineDeduplicateInlineStyles as mo, Burger as mr, noop$1 as ms, useProgressContext as mt, FlatTreeNode as n, FocusTrapInitialFocus as na, AppShellSection as ni, MenuSubItem as nn, useSafeMantineTheme as no, parseColor as nr, getContextItemIndex as ns, Rating as nt, moveTreeNode as o, transitions$1 as oa, AppShellFooter as oi, MenuDropdown as on, ColorSchemeScript as oo, ChipGroup as or, createEventHandler as os, RadioCard as ot, TimelineItem as p, Paper as pa, Affix as pi, ListItem as pn, useMantineCssVariablesResolver as po, ButtonGroup as pr, closeOnEscape as ps, ProgressLabel as pt, SemiCircleProgress as q, v8CssVariablesResolver as qa, ActionIcon as qi, Dialog as qn, getRefProp as qo, ComboboxDropdownTarget as qr, ModalHeader as qt, flattenTreeData as r, usePopoverContext as ra, AppShellNavbar as ri, MenuSubDropdown as rn, mergeMantineTheme as ro, ColorSwatch as rr, getBaseValue$1 as rs, Radio as rt, mergeAsyncChildren as s, OptionalPortal as sa, AppShellAside as si, MenuDivider as sn, useComputedColorScheme as so, ChipGroupContext as sr, getFontSize as ss, RadioCardContext as st, Typography as t, FocusTrap as ta, AppShell as ti, MenuSubTarget as tn, useMantineTheme as to, isColorValid as tr, useHovered as ts, TooltipFloating as tt, useTree as u, useDelayedHover as ua, Anchor as ui, Marquee as un, MantineContext as uo, CardSection as ur, getShadow as us, Progress as ut, TabsTab as v, useScrollAreaContext as va, useAccordionItemContext as vi, Indicator as vn, useMantineStylesTransform as vo, BackgroundImage as vr, getSafeId as vs, PaginationRoot as vt, TableScrollContainer as w, polymorphicFactory as wa, InputBase as wi, HoverCardGroupContext as wn, getPrimaryContrastColor as wo, OptionsDropdown as wr, rem as ws, PaginationDots as wt, useTabsContext as x, DirectionProvider as xa, FloatingIndicator as xi, HoverCardTarget as xn, colorsTuple as xo, AvatarGroupContext as xr, isNumberLike as xs, PaginationLast as xt, TabsPanel as y, Collapse as ya, AccordionChevron as yi, Image as yn, useMantineSxTransform as yo, Avatar as yr, createSafeContext as ys, PaginationItems as yt, useStepperContext as z, useResolvedStylesApi as za, ModalBaseContent as zi, DrawerRoot as zn, resolveStyles as zo, ComboboxOption as zr, useDrawersStack as zt };

//# sourceMappingURL=esm-MOO4wNqQ.js.map